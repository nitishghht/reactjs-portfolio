    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        rounded-2xl"
          />
          <div
            className="absolute inset-0 flex justify-end m-3 card-img-hover0
        "
          >
            <div
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          problem-solving examples. Each project is briefly described, with
          links to code repositories and live demos included. They reflect my
